...
/** @type (actual: any, expected: any, message: string) => void */
...
/** @type (json: string, expectedCount: number) => void */
...
function testInvalidPointerResolution() {
  ...
  try {
    ...
    assert(e instanceof Error && e.message.includes("could not be resolved"), "Error message should mention resolution failure");
  }
}
